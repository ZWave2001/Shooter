...
public class CameraController : MonoSingleton<CameraController>
{
    ...
    [Header("Camera Follow")] [SerializeField] [Tooltip("The transform to follow")]
    ...
    [SerializeField]
    [Tooltip("The speed used in the lerp function when the camera follows the traget")]
        ...
        while (duration > 0)
        {
            ...
            if (direction != default)
            {
                _camera.transform.position +=
                    new Vector3(magnitude * direction.x, magnitude * direction.y, 0) * Time.deltaTime;
            }
